...
params = ModelParams(
    ...
    # sensor parameters
    k_on = 4.5e4,        # association constant [M^-1 s^-1]
    ...
    c_in = 1*1e-9,      # input concentration [mol/L] (1 mol/m^3 = 1 mM)
    V_in = 20000*1e-9,      # volume input [m^3]   (1uL = 1e-9 m^3)
    Q_in = 50,     # volume flow rate [uL/min]
