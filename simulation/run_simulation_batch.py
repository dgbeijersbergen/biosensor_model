...
# parameter ranges
D_vals = [1.11e-11]      # Diffusion coefficient [m^2/s]
#D_vals = [5e-10]     # Diffusion coefficient
c_in_vals = [50e-6]  #input concentration [mol/L = M]

#V_in_vals = [500e-9, 100e-9, 50e-9, 30e-9, 5e-9, 1e-9,0.5e-9]   # Input volume [m3, 1e-9  = 1uL]
V_in_vals = np.logspace(-10,-7,10)      # input volume [m^3]
